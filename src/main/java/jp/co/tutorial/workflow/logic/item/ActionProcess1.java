...
public class ActionProcess1 extends ActionProcessEventListener {
    ...
    /** ロジックコンポーネント. */
    private final ItemPurchaseLogic itemPurchaseLogic;

    /** コンストラクタ. */
    public ActionProcess1() {
        // 自動バインディングは適用されないので、明示的に
        // ロジックコンポーネントを取得する
        this.itemPurchaseLogic = (ItemPurchaseLogic) SingletonS2ContainerFactory
                .getContainer().getComponent(ItemPurchaseLogic.class);
    }
    ...
    public String apply(final ActionProcessParameter parameter,
        ...
        // 旅費登録
        itemPurchaseLogic.createItemPurchase(parameter, userParameter);
    ...
    public void tempSaveUpdate(final ActionProcessParameter parameter, final Map<String, Object> userParameter) {
        ...
        // 一時保存更新
        itemPurchaseLogic.updateItemPurchase(parameter, userParameter);
    ...
    public void tempSaveDelete(final ActionProcessParameter parameter, final Map<String, Object> userParameter) {
        ...
        // 一時保存削除
        itemPurchaseLogic.deleteItemPurchase(parameter.getUserDataId());
