			...
			<table class="imui-form">
				<tbody>
					<tr>
						...
						<td><p>${f:h(approveForm.itemName)}</p></td>
					</tr>
					<tr>
						<th><label>金額</label></th>
						<td><p>${f:h(approveForm.itemPrice)}</p></td>
					</tr>
					<tr>
						<th><label>納入日</label></th>
						<td><p>${f:h(approveForm.itemDate)}</p></td>
					</tr>
					<tr>
						<th><label>購入理由</label></th>
						<td>
							<imui:textArea value='${f:h(approveForm.itemReason)}' id="itemReason" name="itemReason" rows="3" cols="40" readonly="true"/>
						</td>
					</tr>
				</tbody>
			</table>
