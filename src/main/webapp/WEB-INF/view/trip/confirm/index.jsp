			...
			<table class="imui-form">
				<tbody>
					<tr>
						...
						<td><p>${f:h(confirmForm.startDate)}</p></td>
					</tr>
					<tr>
						<th><label>到着日</label></th>
						<td><p>${f:h(confirmForm.arrivalDate)}</p></td>
					</tr>
					<tr>
						<th><label>出張先</label></th>
						<td><p>${f:h(confirmForm.destination)}</p></td>
					</tr>
					<tr>
						<th><label>出張理由</label></th>
						<td>
							<imui:textArea value='${f:h(confirmForm.reason)}' id="reason" name="reason" rows="3" cols="40" readonly="true"/>
						</td>
					</tr>
					<tr>
						<th><label>交通費</label></th>
						<td><p>${f:h(confirmForm.tExpenses)}</p></td>
					</tr>
					<tr>
						<th><label>宿泊費</label></th>
						<td><p>${f:h(confirmForm.lExpenses)}</p></td>
					</tr>
				</tbody>
			</table>
